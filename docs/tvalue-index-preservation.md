...
Original extraction: `develop/3.7.0` at
`74654935b78465ade2043e40b6ff147b43ad8147`, merged in PR #140.
This port targets `develop/3.8.0` at
`3ff1795b31907b84eb67065a5887a8c66500c8a3`; its DUMB2 code and CI gates
are retained. Further optimization work targets 3.8.0. Release 3.7.0 is unchanged.
