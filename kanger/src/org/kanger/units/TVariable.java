...
//    }
    ...
    @Override
    public TVariable setMind(Mind mind) throws ClassNotFoundException, RuntimeErrorException, OutOfBufferException, IOException {
        //TODO: Тут остановился
        Iterator<TValue> iterator = this.mind.getTValues().iterator(this);
        while (iterator.hasNext()) {
            iterator.next().setMind(mind);
        }
        this.mind = mind;
        return this;
    }
