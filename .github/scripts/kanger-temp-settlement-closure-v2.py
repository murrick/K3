...
def replace_once(path, label, old, new):
    ...
    if count != 1:
        raise SystemExit(f"{path} [{label}]: expected one exact replacement, found {count}")
    p.write_text(text.replace(old, new, 1))


replace_once(
    "kanger/src/org/kanger/Mind.java", "import",
    "import org.kanger.factory.*;\n",
    "import org.kanger.factory.*;\nimport org.kanger.exception.TransactionSettlementException;\n")

replace_once(
    "kanger/src/org/kanger/Mind.java", "rejected settlement",
...
replace_once(
    "kanger/src/org/kanger/Mind.java", "committed settlement",
    '''                finishTransactionLocked();
                reservationFinished = true;
                copyCommitResult(child);
                return true;
...
replace_once(
    "kanger/src/org/kanger/Mind.java", "split finalization",
...
replace_once(
    "kanger-server/src/org/kanger/MindLifecycleReactor.java", "import",
    "import org.kanger.exception.StorageLifecycleException;\n",
    "import org.kanger.exception.StorageLifecycleException;\nimport org.kanger.exception.TransactionSettlementException;\n")

replace_once(
    "kanger-server/src/org/kanger/MindLifecycleReactor.java", "typed settlement response",
...
replace_once(
    "kanger-server/test/org/kanger/WorkspaceStateReactorTest.java", "new A-to-B projection",
