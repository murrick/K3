...
EXPECTED_CURRENT_UI_TARGET="${KANGER_EXPECTED_CURRENT_UI_TARGET:-/home/murray/sites/kanger-3.7.0.6-vps-soak-20260810T163710Z}"
...
EXPECTED_CURRENT_JAR_SHA256="${KANGER_EXPECTED_CURRENT_JAR_SHA256:-afb72c6569e3496be972cd56ce974998132cf49586948669c8b4e2b8c634d0fe}"
EXPECTED_CANDIDATE_SERVER="${KANGER_EXPECTED_CANDIDATE_SERVER_VERSION:-server-0.18}"
EXPECTED_SOURCE_HEAD="5c0cd3662cbadbd63e78ebbc6a23131f1b9682b7"
EXPECTED_PACKAGING_BRANCH="ops/3.7.0.7-vps-soak"
STAMP="$(date -u +%Y%m%dT%H%M%SZ)"
RECORD_DIR="${KANGER_DEPLOYMENT_RECORD_ROOT:-/root/kanger-deployments}/3.7.0.7-vps-soak-${STAMP}"
CANDIDATE_UI="${SITE_ROOT}/kanger-3.7.0.7-vps-soak-${STAMP}"
...
grep -q '^artifact=3.7.0.7-vps-soak$' "${BUNDLE_DIR}/SOURCE.txt"
...
grep -q '^prior_development_soak=3.7.0.6$' "${BUNDLE_DIR}/SOURCE.txt"
...
rollback_on_error() {
  ...
  echo "Deployment failed; restoring prior 3.7.0.6 development soak Server/UI" >&2
  set +e
