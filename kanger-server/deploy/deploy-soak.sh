...
EXPECTED_CURRENT_UI_TARGET="${KANGER_EXPECTED_CURRENT_UI_TARGET:-/home/murray/sites/kanger-3.7.0.7-vps-soak-20260811T051011Z}"
...
EXPECTED_CURRENT_JAR_SHA256="${KANGER_EXPECTED_CURRENT_JAR_SHA256:-99ba358d177a1e947cfd8de1fef86da57609e86aa95e3a84d2d128e69ec49f93}"
EXPECTED_CANDIDATE_SERVER="${KANGER_EXPECTED_CANDIDATE_SERVER_VERSION:-server-0.18}"
EXPECTED_SOURCE_HEAD="ff3ac0a338cfa72ce0ac3660c6fd215bb7da3b2f"
EXPECTED_PACKAGING_BRANCH="ops/3.7.0.8-vps-soak"
STAMP="$(date -u +%Y%m%dT%H%M%SZ)"
RECORD_DIR="${KANGER_DEPLOYMENT_RECORD_ROOT:-/root/kanger-deployments}/3.7.0.8-vps-soak-${STAMP}"
CANDIDATE_UI="${SITE_ROOT}/kanger-3.7.0.8-vps-soak-${STAMP}"
...
grep -q '^artifact=3.7.0.8-vps-soak$' "${BUNDLE_DIR}/SOURCE.txt"
...
grep -q '^prior_development_soak=3.7.0.7$' "${BUNDLE_DIR}/SOURCE.txt"
...
rollback_on_error() {
  ...
  echo "Deployment failed; restoring prior 3.7.0.7 development soak Server/UI" >&2
  set +e
