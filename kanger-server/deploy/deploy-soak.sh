...
EXPECTED_SOURCE_HEAD="b0ed1cee70d6a4bbaf3b7690df766b9eae41f891"
STAMP="$(date -u +%Y%m%dT%H%M%SZ)"
RECORD_DIR="${KANGER_DEPLOYMENT_RECORD_ROOT:-/root/kanger-deployments}/3.5.2-server-0.18-soak-${STAMP}"
CANDIDATE_UI="${SITE_ROOT}/kanger-server-0.18-soak-${STAMP}"
...
grep -q '^packaging_branch=ops/3.5.2-server-0.18-vps-soak$' "${BUNDLE_DIR}/SOURCE.txt"
