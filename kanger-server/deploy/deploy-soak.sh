...
EXPECTED_SOURCE_HEAD="f9419c9428424b958bd938db0f6cf29650acf3f0"
EXPECTED_PACKAGING_BRANCH="ops/3.5.2-server-0.18-vps-soak-r2"
STAMP="$(date -u +%Y%m%dT%H%M%SZ)"
RECORD_DIR="${KANGER_DEPLOYMENT_RECORD_ROOT:-/root/kanger-deployments}/3.5.2-server-0.18-soak-r2-${STAMP}"
CANDIDATE_UI="${SITE_ROOT}/kanger-server-0.18-soak-r2-${STAMP}"
...
grep -q '^packaging_generation=r2$' "${BUNDLE_DIR}/SOURCE.txt"
