...
EXPECTED_PUBLIC_UI_TARGET="${KANGER_EXPECTED_PUBLIC_UI_TARGET:-/home/murray/sites/kanger-3.7.0.5-vps-soak-20260810T125400Z}"
EXPECTED_SERVER_VERSION="${KANGER_EXPECTED_CURRENT_SERVER_VERSION:-server-0.18}"
EXPECTED_JAR_SHA256="${KANGER_EXPECTED_CURRENT_JAR_SHA256:-5a25dbf5f563f9cd36647ca75566798a39335b076d5b123b8d5e5f3a7501e763}"
SNAPSHOT_ROOT="${KANGER_SNAPSHOT_ROOT:-/root/kanger-snapshots}"
STAMP="$(date -u +%Y%m%dT%H%M%SZ)"
NAME="kanger-vps-before-3.7.0.6-${STAMP}"
...
purpose=pre-3.7.0.6-development-soak rollback and disaster recovery
EOF
