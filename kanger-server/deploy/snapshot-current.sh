...
EXPECTED_PUBLIC_UI_TARGET="${KANGER_EXPECTED_PUBLIC_UI_TARGET:-/home/murray/sites/kanger-server-0.18-soak-r3-20260807T100726Z}"
EXPECTED_SERVER_VERSION="${KANGER_EXPECTED_CURRENT_SERVER_VERSION:-server-0.18}"
EXPECTED_JAR_SHA256="${KANGER_EXPECTED_CURRENT_JAR_SHA256:-9a8fb1a0f1505d74fb15343ed0519782abb33b53097d6c0e46fbad7bad962718}"
SNAPSHOT_ROOT="${KANGER_SNAPSHOT_ROOT:-/root/kanger-snapshots}"
STAMP="$(date -u +%Y%m%dT%H%M%SZ)"
NAME="kanger-vps-before-3.7.0.5-${STAMP}"
...
purpose=pre-3.7.0.5-development-soak rollback and disaster recovery
EOF
