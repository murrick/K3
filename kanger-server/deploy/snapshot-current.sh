...
EXPECTED_PUBLIC_UI_TARGET="${KANGER_EXPECTED_PUBLIC_UI_TARGET:-/home/murray/sites/kanger-3.7.0.7-vps-soak-20260811T051011Z}"
EXPECTED_SERVER_VERSION="${KANGER_EXPECTED_CURRENT_SERVER_VERSION:-server-0.18}"
EXPECTED_JAR_SHA256="${KANGER_EXPECTED_CURRENT_JAR_SHA256:-99ba358d177a1e947cfd8de1fef86da57609e86aa95e3a84d2d128e69ec49f93}"
SNAPSHOT_ROOT="${KANGER_SNAPSHOT_ROOT:-/root/kanger-snapshots}"
STAMP="$(date -u +%Y%m%dT%H%M%SZ)"
NAME="kanger-vps-before-3.7.0.8-${STAMP}"
...
purpose=pre-3.7.0.8-development-soak rollback and disaster recovery
EOF
