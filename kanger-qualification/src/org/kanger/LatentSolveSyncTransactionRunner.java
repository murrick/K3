...
public final class LatentSolveSyncTransactionRunner {
    ...
    private static void query(Mind mind, String label, String source, Boolean expectedTrue) throws Exception {
        ...
        states.add("pass-actions=" + Arrays.toString(s.getPassActionMasks()) + ";started=" + s.getPasses());
        ...
        work.add(label + " sync=" + Arrays.toString(s.getSolveSync()) + " new-tsolves=" + effects.getNewTSolves());
    }
